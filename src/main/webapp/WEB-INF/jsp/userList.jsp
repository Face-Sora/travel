                                    ...
                                    <tr>
                                        ...
                                        <c:if test="${user.status == 1}">
                                         ...
                                         <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/user/message?id=${user.id}"'>详情</button>
                                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/role/findElse?id=${user.id}"'>添加角色</button>
                                        </td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
